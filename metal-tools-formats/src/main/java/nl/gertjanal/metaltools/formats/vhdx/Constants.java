...
public class Constants {
	 ...
	 *
	 * @param guid
	 *            GUID, for example "caa16737-fa36-4d43-b3b6-33f0aa44e76b"
	...
	public static Expression guid(final String guid) {
		...
		// Note that GUID bytes differ from UUID bytes, as the first 3 parts are
		// reversed
		// Use ByteBuffer instead of long to make sure no leading zeroes are
		// omitted
