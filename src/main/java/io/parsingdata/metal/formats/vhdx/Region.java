...
import static io.parsingdata.metal.formats.vhdx.Constants.guid;
import static io.parsingdata.metal.formats.vhdx.Metadata.METADATA_TABLE_HEADER;

import io.parsingdata.metal.token.Token;

/**
 * Metal tokens for VHDX Region.
...
public class Region {
    ...
    private static Token regionTableEntry(final String name, final String guid, final Token token) {
        return seq(name,
            ...
            // The FileOffset and Length fields specify the 64-bit byte offset and 32-bit byte length of the object within the file.
            // The values must be a multiple of 1 MB, and FileOffset must be at least 1 MB.
            ...
            // The Required field specifies whether this region must be recognized by the parser in order to load the VHDX file.
            // If this field’s value is 1 and the parser does not recognize this region, the parser must refuse to load the VHDX file.
